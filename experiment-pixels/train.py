...
# # got this around July 25, 2024
# # def get_args():
# #     parser = argparse.ArgumentParser(description=None)
# #     parser.add_argument('--input_dim', default=28**2, type=int, help='dimensionality of input tensor')  # For grayscale images
# #     # If RGB, use: parser.add_argument('--input_dim', default=3*28**2, type=int, help='dimensionality of input tensor')
# #     parser.add_argument('--hidden_dim', default=200, type=int, help='hidden dimension of mlp')
# #     parser.add_argument('--latent_dim', default=2, type=int, help='latent dimension of autoencoder')
# #     parser.add_argument('--learn_rate', default=1e-3, type=float, help='learning rate')
# #     parser.add_argument('--input_noise', default=0.0, type=float, help='std of noise added to HNN inputs')
...
# def get_args():
#     parser = argparse.ArgumentParser(description=None)
#     parser.add_argument('--input_dim', default=28*28*2, type=int, help='dimensionality of input tensor')  # Adjusted input_dim to 28*28
#     parser.add_argument('--hidden_dim', default=200, type=int, help='hidden dimension of mlp')
#     parser.add_argument('--latent_dim', default=2, type=int, help='latent dimension of autoencoder')
#     parser.add_argument('--learn_rate', default=1e-3, type=float, help='learning rate')
#     parser.add_argument('--input_noise', default=0.0, type=float, help='std of noise added to HNN inputs')
#     parser.add_argument('--batch_size', default=200, type=int, help='batch size')
#     parser.add_argument('--nonlinearity', default='Tanh', type=str, help='neural net nonlinearity')  # Corrected nonlinearity to Tanh
#     parser.add_argument('--total_steps', default=10000, type=int, help='number of gradient steps')
#     parser.add_argument('--print_every', default=200, type=int, help='number of gradient steps between prints')
#     parser.add_argument('--verbose', dest='verbose', action='store_true', help='verbose?')
#     parser.add_argument('--name', default='pixels', type=str, help='either "real" or "sim" data')
...
#     print(f"next_x shape: {next_x.shape}")  # Print the shape of the next state tensor
...
def get_args():
    parser = argparse.ArgumentParser(description=None)
    parser.add_argument('--input_dim', default=4*4*28*28*2, type=int, help='dimensionality of input tensor')  # Adjusted input_dim to 28*28*2
    parser.add_argument('--hidden_dim', default=200, type=int, help='hidden dimension of mlp')
